...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: 6dEAhn3gzU1vE/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__trTA, {
            [sty.box__long__trTAzkm8B]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__cRawV, {
              [sty.box__long__cRawVzkm8B]: hasVariant(variants, "long", "long")
            })}
          >
            <p.PlasmicSlot
              defaultContents={
                <svg
                  className={classNames(defaultcss.all, sty.svg__hunT)}
                  role={"img"}
                />
              }
      ...
      <div
        className={classNames(defaultcss.all, sty.box___4Pg3, {
          [sty.box__long___4Pg3Zkm8B]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__y5Jsp, {
            [sty.box__long__y5JspZkm8B]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__crsto)}
                role={"img"}
              />
            }
            value={args.iconBack}
