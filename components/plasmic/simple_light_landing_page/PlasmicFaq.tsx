...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: MalYTn95NjUzwh/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__dvfVd)}
      >
        <div className={classNames(defaultcss.all, sty.box__kxEwt)}>
          <div className={classNames(defaultcss.all, sty.box___17Vtl)}>
            <p.PlasmicSlot
