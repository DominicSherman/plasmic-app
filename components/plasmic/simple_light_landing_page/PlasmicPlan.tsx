...
import BaseCard from "../../BaseCard"; // plasmic-import: kmuH-e99t0Vp3f/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: 5QLJTMyfS0fL6L/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__hecWj)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__xfD7Y)}
        >
          <p.PlasmicSlot
          ...
          <p.PlasmicSlot
            defaultContents={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__qxTyc)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__r9Qwk)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___1T1KN)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__meTil)}
                />
              </p.Stack>
            }
          ...
          <div className={classNames(defaultcss.all, sty.box__rEwTq)}>
            <p.PlasmicSlot
              defaultContents={
                <LinkButton
