...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: wQrpetOcr3nlu/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__lza5C)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__x5Dd)}
        >
          <div className={classNames(defaultcss.all, sty.box__wtKge)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__uzl00)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__fPLzi)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__sA7Yr)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box___8TWe)}>
          <img
